...
class Metaclass_Telemetry(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('telemetry_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'telemetry_interfaces.msg.Telemetry')
            logger.debug(
...
class Telemetry(metaclass=Metaclass_Telemetry):
    ...
    def time_stamp(self, value):
        if self._check_fields:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'time_stamp' field must be an integer in [-2147483648, 2147483647]"
    ...
    def gps_latitude(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gps_latitude' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def gps_longitude(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gps_longitude' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
