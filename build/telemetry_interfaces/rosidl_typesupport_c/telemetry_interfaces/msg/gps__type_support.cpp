...
static const _Gps_type_support_symbol_names_t _Gps_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, telemetry_interfaces, msg, Gps)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, telemetry_interfaces, msg, Gps)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, telemetry_interfaces, msg, Gps)() {
  return &::telemetry_interfaces::msg::rosidl_typesupport_c::Gps_message_type_support_handle;
}
